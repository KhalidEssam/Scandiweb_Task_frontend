              ...
              prices: [
                  {
                    ...
                    currency: { label: "${item.prices[0].currency.label}", symbol: "${item.prices[0].currency.symbol}" }
                  },
              ],
              count: ${item.count},
            }
...
// graphql localhost
export const localhost = 'http://localhost/fullstack_assignment/gql_test/src/graphql.php';

// graphql production
export const production = 'https://ecommercescandweb.000webhostapp.com/Fullstack_assignment/gql_test/src/graphql.php';
